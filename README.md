...
1. An activity prediction track where entrants estimate the pEC50 for a variety of drug molecules in PXR
2. A structure prediction track where entrants generate structures of a handful of ligand-PXR complexes

Both results are validated against experimental data from OpenADMET and their partners at Octant.
